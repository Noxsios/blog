...
{{ figure(src="https://m.media-amazon.com/images/I/81ihE0urW7S.jpg",
          style="width: 50%;",
          position="center"
...
In an Apple ecosystem, (sadly) you have to use Apple accessories. The gesture control alone is worth it.
...
{{ figure(src="https://whoosh.com/cdn/shop/files/Website_Go.jpg?v=1738007855&width=1346",
          style="width: 50%;",
          position="center"
          caption_position="center",
...
It has the following key features I wanted at a price that did not cost an arm and a leg:
