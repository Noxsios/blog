...
Here is `k9s` running the equivalent of `mkdir -p` within its startup: <https://github.com/derailed/k9s/blob/c2bbcd4c7220095ad441af456159da2813fc2114/cmd/root.go#L55-L58> (& creates a hidden dependency upon the filesystem)
