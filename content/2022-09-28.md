...
For all my tools I like using the `macchiato` color scheme from [catppuccin](https://github.com/catppuccin)
...
Throw a system monitor in the top status bar on Mac.
