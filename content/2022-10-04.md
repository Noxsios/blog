...
There are two VolumeMounts created for this pod, `zarf-stage1` which is a collection of __ConfigMaps__, and `zarf-stage2` which is initialized as an __EmptyDir__ _(this distinction is important later on)_.
